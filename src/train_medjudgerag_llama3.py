#!/usr/bin/env python3
"""
train_medjudgerag_llama3.py - MedJudgeRAG LoRA SFT (KG → Analysis → Answer) for Llama.

Uses the same compact KG prompt as the released teacher traces.
Training data: full_teacher_traces_llama3_8192.jsonl (GPT end-to-end generation with raw retrieved documents).

Usage:
    PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \\
    CUDA_VISIBLE_DEVICES=2,3 accelerate launch --num_processes 2 --mixed_precision bf16 \\
        src/train_medjudgerag_llama3.py --deepspeed configs/deepspeed_zero2.json \\
        --model_name meta-llama/Meta-Llama-3-8B-Instruct \\
        --train_data data/full_teacher_traces_llama3_8192.jsonl \\
        --val_data data/full_teacher_traces_llama3_8192.jsonl \\
        --epochs 3 --max_seq_len 8192 --kg_weight 0.0 --analysis_weight 1.0 \\
...
def main():
    ...
    parser.add_argument("--train_data", default="data/full_teacher_traces_llama3_8192.jsonl")
    parser.add_argument("--val_data", default="data/full_teacher_traces_llama3_8192.jsonl")
    parser.add_argument("--model_name", default="meta-llama/Meta-Llama-3-8B-Instruct",
                        help="Base model")
    parser.add_argument("--output_dir", default="outputs/medjudgerag_llama3_lora")
